...
void loop() {
  ...
  if (currentMillis - previousMillis >= 10){
    ...
    if (Serial.available()>0){
      char c = Serial.read();
//      Serial.print("thieeeeeeeeeeeee");
      if (c == "a"){
        // drive meter test
        demand1 = 6440; // 1509 , 3018
        demand2 = 6440;
        Serial.print(demand1);
        Serial.print(" , ");
        Serial.println(demand2);
      }
      else if (c == "b"){
        demand1 = 0.2; // 1509 , 3018
        demand2 = 0.2;
      }
      else if (c == "c"){
        // turn 1 rad/s
...
//    
//    encoder0Error = (demand1*60) - encoder0Driff;
//    encoder1Error = (demand2*60) - encoder1Driff;
//
