...
double wheelbase = 0.22;                          //Wheelbase, in m
...
void handle_speed_left( const geometry_msgs::Vector3Stamped& speed) {
...
void handle_speed_right( const geometry_msgs::Vector3Stamped& speed) {
...
int main(int argc, char** argv){
  ...
  ros::Subscriber sub_l = n.subscribe("speed_left", 50, handle_speed_left);
  ros::Subscriber sub_r = n.subscribe("speed_right", 50, handle_speed_right);
